...
[debug0,sand0_left, sand0_right] = aprilTag_vbap(sand0_tagID, sand0_dist, sand0_head,target_range0,boat_range0)
...
[debug1,sand1_left, sand1_right] = aprilTag_vbap(sand1_tagID, sand1_dist, sand1_head, target_range1,boat_range1)
...
boat_range2 = [ 0, 1, 2, 3;
               10,11,12,13];
%----------- Calculate and Publish Thrust Commands-----------------
[debug2,sand2_left, sand2_right] = aprilTag_vbap(sand2_tagID, sand2_dist, sand2_head,target_range2,boat_range2)
